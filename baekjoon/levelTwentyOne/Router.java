...
/*
문제 : 인터넷을 사용하기 위해서는 컴퓨터에 인터넷 회선을 연결하거나 Wi-Fi를 연결해야 한다. 
...
입력 : 첫 줄에는 라우터 내부에 존재하는 버퍼의 크기를 나타내는 자연수 N이 주어진다.
	  ...
	  -1은 입력의 끝을 나타낸다.
출력 : 라우터에 남아있는 패킷을 앞에서부터 순서대로 공백으로 구분해서 출력하면 된다. 만약 비어있을 경우 empty라고 출력한다.
*/
...
public class Router {
	...
	public static void main(String[] args) throws IOException {
		...
		while(true) {
			...
			if(num == 0) {
				Q.poll();
			// 입력받은 수가 큐의 크기보다 크다면 버퍼에 값을 넣는다.
